...
const tabs = [
  ...
  },
  {
    href: "/discover",
    label: "Discover",
    match: (p: string) => p.startsWith("/discover") || p.startsWith("/search") || p.startsWith("/themes") || p.startsWith("/blog"),
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    href: "/shop",
    label: "Shop",
    match: (p: string) => p.startsWith("/shop") || p.startsWith("/new") || p.startsWith("/sale") || p.startsWith("/retiring-soon") || p.startsWith("/coming-soon"),
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
